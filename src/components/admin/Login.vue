<template>
  <div id="wrap"  class="animated rotateInUpLeft">
    <el-form :model="ruleForm2" :rules="rules2" ref="ruleForm2" label-position="left" label-width="0px" class="demo-ruleForm login-container" :class="move" v-show="move.length">
      <h3 class="title">供应商管理员登录</h3>
      <el-form-item prop="account">
        <el-input type="text" v-model="ruleForm2.account" auto-complete="off" placeholder="请输入手机号"></el-input>
      </el-form-item>
      ...
      handleSubmit2(ev) {
        ...
        this.$refs.ruleForm2.validate((valid) => {
          if (valid) {
            ...
            this.$http.post('http://hly.lxs.1000da.com.cn/AgentInfo/Login',JSON.stringify(loginParams),{
              headers: {
